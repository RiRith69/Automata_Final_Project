...
st.set_page_config(page_title="NFA Killer", layout="wide")
is_logged_in()
...
def main():
    ...
    st.markdown("Convert a similar DFA for your NFA.")
    ...
    if fa.fa_type == "NFA" :
        ...
        st.warning("Your FA is DFA! Please choose a NFA to convert.")
